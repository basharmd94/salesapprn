...
const deviceIP = '192.168.1.77'; // Change this to your computer's IP address

// Set baseURL based on platform for production
const baseURL = Platform.select({
    android: __DEV__
        ? `http://${deviceIP}:8000/api/v1`  // Development - use deviceIP
        : 'https://127.0.0.1/api/v1',  // Production
    ios: __DEV__
        ? `http://${deviceIP}:8000/api/v1`  // Development - use deviceIP
        : 'https://127.0.0.1/api/v1',  // Production
    default: `http://${deviceIP}:8000/api/v1`  // Web/Default
});
