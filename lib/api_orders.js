...
export const getConfirmedOrders = async () => {
  try {
    ...
    console.error('Error fetching confirmed orders:', error.response?.data || error.message);
    throw error;
  }
};
...
export const getCancelledOrders = async () => {
  try {
    ...
    console.error('Error fetching cancelled orders:', error.response?.data || error.message);
    throw error;
  }
};
